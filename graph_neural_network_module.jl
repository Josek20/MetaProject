module GraphNeuralNetwork
    ...
    export GraphNN, train_model, evaluate_model, extract_and_apply_max_rule, clear_non_max_rules!, rule_application_locations, get_rule_applicability_matrix, extract_max_rule_id, clear_non_max_rules!, my_softmax, loss
